...
var script__$1 = (function (){var G__85 = script;
(G__85["type"] = "text/javascript");

return G__85;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__86 = script__$1;
(G__86["src"] = src);

return G__86;
})():(function (){var G__87 = script__$1;
goog.dom.setTextContext(G__87,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__3102__auto__ = reload;
...
var path_88 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_88];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_88)].join('')];
} else {
}
